...
public class ActionsSendKeysAndClick {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		act.sendKeys(driver.findElement(emailId), "ravi@gmail.com").perform();
...
//		This method isdifferent from WebElement.sendKeys(CharSequence)
//		- see sendKeys(CharSequence) for details how.
	...
	public static void doActionsSendKeys(By locator) {
		Actions act = new Actions(driver);
